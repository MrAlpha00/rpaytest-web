        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">eBook Store</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Your trusted source for premium technical eBooks on cybersecurity, networking, 
              Linux, and more. Learn from industry experts and advance your career.
            </p>
